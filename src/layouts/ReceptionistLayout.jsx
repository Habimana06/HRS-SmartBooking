...
function ReceptionistLayout() {
  ...
  const navItems = [
    { title: "Dashboard", path: "/receptionist/dashboard", icon: "📊" },
    { title: "Check-in", path: "/receptionist/check-in", icon: "✅" },
    { title: "Check-out", path: "/receptionist/check-out", icon: "🚪" },
    { title: "Reservations", path: "/receptionist/manage-reservations", icon: "📅" },
    { title: "Room Availability", path: "/receptionist/room-availability", icon: "🛏️" },
    { title: "Customer Requests", path: "/receptionist/customer-requests", icon: "📋" },
    { title: "Messages", path: "/receptionist/messages", icon: "💬" },
    { title: "Profile", path: "/receptionist/profile", icon: "👤" },
  ];
        ...
        <div className="p-4 border-b border-secondary-700 flex items-center justify-between flex-shrink-0">
          {!sidebarCollapsed && (
            <div>
              ...
              <h2 className="text-xl font-extrabold text-white">Reception Portal</h2>
            </div>
          )}
          <button
