...
function ManagerLayout() {
  ...
  const navItems = [
    ...
    { title: "Manage Rooms", path: "/manager/manage-rooms", icon: "🛏️" },
    { title: "Add Room", path: "/manager/add-room", icon: "➕" },
    { title: "Manage Bookings", path: "/manager/manage-bookings", icon: "📅" },
    { title: "Travel Bookings", path: "/manager/manage-travel-bookings", icon: "✈️" },
    { title: "Amenities", path: "/manager/manage-amenities", icon: "⭐" },
    { title: "Room Types", path: "/manager/room-types", icon: "🏨" },
    { title: "Staff", path: "/manager/staff-management", icon: "👥" },
    { title: "Reports", path: "/manager/financial-reports", icon: "📈" },
    { title: "Feedback", path: "/manager/customer-feedback", icon: "💬" },
    { title: "Profile", path: "/manager/profile", icon: "👤" },
  ];
        ...
        <div className="p-4 border-b border-secondary-700 flex items-center justify-between flex-shrink-0">
          {!sidebarCollapsed && (
            <div>
              ...
              <h2 className="text-xl font-extrabold text-white">Manager Portal</h2>
            </div>
          )}
          <button
