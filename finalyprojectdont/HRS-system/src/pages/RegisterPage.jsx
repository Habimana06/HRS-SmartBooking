        ...
        <div className="relative z-10 flex flex-col justify-center items-center text-white p-12 w-full">
          <div className="max-w-md space-y-6 animate-fade-in-up">
            ...
            <p className="text-xl text-white/95 drop-shadow-lg leading-relaxed font-light">
              Create your account and start your journey with us. Unlock exclusive benefits and personalized experiences.
            </p>
            <div className="space-y-3 pt-6">
              <div className="flex items-center space-x-3 text-white/90">
                ...
                <span className="font-medium">Best rates guaranteed</span>
              </div>
              <div className="flex items-center space-x-3 text-white/90">
                <div className="w-8 h-8 rounded-lg bg-white/20 backdrop-blur-sm flex items-center justify-center">
                  <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-center space-x-3 text-white/90">
                ...
                <span className="font-medium">Exclusive member rewards</span>
              </div>
            </div>
          </div>
        </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      required
                      className="relative w-full px-4 py-3.5 bg-gray-50 dark:bg-gray-900/50 border-2 border-gray-200 dark:border-gray-700 rounded-xl text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-300"
                      placeholder="John"
                    />
                  </div>
                </div>
